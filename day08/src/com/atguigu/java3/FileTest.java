...
public class FileTest {
    ...
    */
    ...
    public void test1() {
        ...
        File file2 = new File("E:\\IDEA\\workspace_idea1\\JavaSenior\\day08\\he.txt");

        System.out.println(file1);
        System.out.println(file2);

        // 构造器2
        File file3 = new File("E:\\IDEA\\workspace_idea1", "JavaSenior");
    ...
    */
    ...
    public void test2() {
        ...
        System.out.println(file1.getAbsolutePath()); // E:\IDEA\workspace_idea1\JavaSenior\day08\hello.txt
        System.out.println(file1.getPath()); // hello.txt
        System.out.println(file1.getName()); // hello.txt
        System.out.println(file1.getParent()); // null
        System.out.println(file1.length()); // 10
        System.out.println(new Date(file1.lastModified())); // Sun Jul 18 15:10:20 CST 2021
    ...
    @Test
    public void test3() {
        File file = new File("E:\\IDEA\\workspace_idea1\\JavaSenior");
